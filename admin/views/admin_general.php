	...
	<div class="optpoint_item">
		...
		<div ng-switch="mailserv.isConfig">
			...
			<div ng-switch-when="1">
				<div class="optpoint_group">
					<optsel optlab="Mailing Service" ng-head="mailserv.list[mailserv.config.id].name" opthead="'Not Selected'" ng-list="mailserv.list" ng-model="mailserv.config.id" optclk="k" optlname="v.name"></optsel>
				</div>
				<div class="optpoint_group">
					...
					<div class="optpoint_table optpoint_tablefo">
						...
						<div class="optpoint_tablerg">
							<div class="optpoint_tabler" ng-repeat="cform in data.cforms track by $index">
								...
								<div>
									<div class="mul_ico mul_edit" ng-click="form.edit($index)"></div>
								</div>
								<div></div>
							</div>
						</div>
								...
								<div class="optpoint_tabler optpoint_tablefi" ng-repeat="cfield in form.tform.fields" as-sortable-item class="as-sortable-item mulfieldr">
									...
									<div class="optpoint_tablefed">
										<div class="optpoint_tablefed_box" ng-if="field.ed == $index">
											...
											<div class="optpoint_tablefed_row" ng-if="field.extra.fill() && ['checkbox','radio','select','multiselect'].indexOf(cfield.type) >= 0">
												<label>Options</label>
												<div class="optpoint_tablefed_col">
													<div class="optpoint_tablefed_opt" ng-repeat="(k,v) in cfield.extras track by k">
														<div ng-if="field.extra.fill()">
															...
															<div class="bar"></div>
															<div class="fed_ico mul_del" ng-click="field.extra.del($parent.$index, $index)"></div>
														</div>
														<div ng-if="!field.extra.fill()">
														{{cfield.extras[k].label || cfield.extras[k].name}}
														</div>
													</div>
													<div class="optpoint_tablefed_optadd" ng-click="field.extra.add($parent.$index)" ng-if="field.extra.fill()"></div>
